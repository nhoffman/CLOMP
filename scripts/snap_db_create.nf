...
FASTA_CHANNEL = Channel.fromPath("s3://clomp-reference-data/aligner-testing/refseq_fna/*")
process build_snap_index {
 container 'quay.io/fhcrc-microbiome/snap-no-header:v1.0beta.18--0'
 publishDir 's3://clomp-reference-data/aligner-testing/refseq_small_indexes/' , mode: 'copy'
